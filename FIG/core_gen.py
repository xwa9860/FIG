...
class CoreGen(Gen):
    ...
    def parse(self, a_core, type):
        if type == 's':
            ...
            str_list.append('det 1 dr -8 void dn 1 0  175 35 0 360 1 41 573 38\n')

            str_list.append('%% detector for thermal neutron flux\n')
            str_list.append('ene 1 1 1E-11 0.625E-6\n')
            str_list.append('det 2 de 1 dn 1 0  175 35 0 360 1 41 573 38\n')
            str_list.append('%% detector for fast neutron flux\n')
            str_list.append('ene 2 1 0.625E-6 200\n')
            str_list.append('det 3 de 2 dn 1 0  175 35 0 360 1 41 573 38\n')
