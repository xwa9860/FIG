...
from mat import YH2, ZrH2, Graphite, YH2CoolMix, GraphiteCoolMix, ZrH2CoolMix
from comp import *
...
class OuterRef(Comp):
    ...
    def __init__(self, temp):
        name = 'OR'
        Comp.__init__(self, temp, name, [ZrH2(temp)])
...
class OuterRef_CoolantChannel(Comp):
    ...
    def __init__(self, temp, cool_temp):
        name = 'ORCC'
        Comp.__init__(self, temp, name, [ZrH2CoolMix(cool_temp)])
